        ...
        <div className="root-2">
            {<div className='page-2'>
                <div className='header-2 row'>
                    <div className="scope-1 row">
                        <div className='menu-btn'>
                            <svg viewBox="0 0 24 24" focusable="false"><g class="style-scope yt-icon"><path d="M21,6H3V5h18V6z M21,11H3v1h18V11z M21,17H3v1h18V17z"></path></g></svg>
                        </div>
                        <div className='logo-2'>
                            <svg focusable="false" viewBox = "0 0 90 20">
                                <g>
                                    <g>
                    ...
                    <div className='scope-2'>
                        <div className='search row'>
                            ...
                            <div dir="ltr" className='inp-type'>
                                <img src="//www.gstatic.com/inputtools/images/tia.png" alt=""/>
                            </div>
                            <div className='serach-btn'>
                                <button id="search-icon-legacy" aria-label="Введите запрос">
                ...
                <div className='content-2'>
                    <div className='menu col'>
                        ...
                        <ul className="col">
                            <li>
                                <svg viewBox="0 0 24 24" focusable="false"><g><path d="M9.8,9.8l-3.83,8.23l8.23-3.83l3.83-8.23L9.8,9.8z M13.08,12.77c-0.21,0.29-0.51,0.48-0.86,0.54 c-0.07,0.01-0.15,0.02-0.22,0.02c-0.28,0-0.54-0.08-0.77-0.25c-0.29-0.21-0.48-0.51-0.54-0.86c-0.06-0.35,0.02-0.71,0.23-0.99 c0.21-0.29,0.51-0.48,0.86-0.54c0.35-0.06,0.7,0.02,0.99,0.23c0.29,0.21,0.48,0.51,0.54,0.86C13.37,12.13,13.29,12.48,13.08,12.77z M12,3c4.96,0,9,4.04,9,9s-4.04,9-9,9s-9-4.04-9-9S7.04,3,12,3 M12,2C6.48,2,2,6.48,2,12s4.48,10,10,10s10-4.48,10-10S17.52,2,12,2 L12,2z"></path></g></svg>
                                <a href="#/">Навигатор</a></li>
                            <li><svg viewBox="0 0 24 24" focusable="false"><g><path d="M4,10V21h6V15h4v6h6V10L12,3Z"></path></g></svg><a href="#/">Главная</a></li>
                            <li><svg viewBox="0 0 24 24" focusable="false">
                    ...
                    <div className='col other'>
                        <div className='filter row'>
                            <div class="chip">
                                <div class="chip-c">Видеоигры</div>
                            </div>
                            <div class="chip">
                                <div class="chip-c">Сейчас в эфире</div>
                            </div>
                            <div class="chip sel">
                                <div class="chip-c">Выбранный</div>
                            </div>
                            <div class="chip">
                                <div class="chip-c">Котята</div>
                            </div>
                        </div>
                        <div className='main-content'>
                            <div class="my-flex-cont">
                                <div class="my-flex-box">Блок 1</div>
                                <div class="my-flex-box">Блок 2</div>
                                <div class="my-flex-box">Блок 4</div>
                                <div class="my-flex-box">Блок 5</div>
                                <div class="my-flex-box">Блок 6</div>
                                <div class="my-flex-box">Блок 7</div>
                                <div class="my-flex-box">Блок 8</div>
                                <div class="my-flex-box">Блок 9</div>
                                <div class="my-flex-box">Блок 10</div>
                                <div class="my-flex-box">Блок 11</div>
                                <div class="my-flex-box">Блок 14</div>
                                <div class="my-flex-box">Блок 15</div>
                            </div>
                        </div>
                    </div>
                </div>
